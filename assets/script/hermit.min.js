...
(function(g,i){function R(R,ia){function S(b){return c.preferFlash&&r&&!c.ignoreFlash&&c.flash[b]!==i&&c.flash[b]}function n(b){return function(c){var d=this._s;return!d||!d._a?null:b.call(this,c)}}this.setupOptions={url:R||null,flashVersion:8,debugMode:!0,debugFlash:!1,useConsole:!0,consoleOnly:!0,waitForWindowLoad:!1,bgColor:"#ffffff",useHighPerformance:!1,flashPollingInterval:null,html5PollingInterval:null,flashLoadTimeout:1E3,wmode:null,allowScriptAccess:"always",useFlashBlock:!1,useHTML5Audio:!0,
    ...
    ba=function(b){return!b||!b.type&&!b.url&&!b.serverURL?!1:b.serverURL||b.type&&S(b.type)?!1:b.type?Q({type:b.type}):Q({url:b.url})||c.html5Only||b.url.match(/data\:/i)};ca=function(b){var e;b&&(e=fa?"about:blank":c.html5.canPlayType("audio/wav")?"data:audio/wave;base64,/UklGRiYAAABXQVZFZm10IBAAAAABAAEARKwAAIhYAQACABAAZGF0YQIAAAD//w==":"about:blank",b.src=e,void 0!==b._called_unload&&(b._called_load=!1));x&&(Aa=null);return e};Q=function(b){if(!c.useHTML5Audio||!c.hasHTML5)return!1;var e=b.url||null,
        ...
        if(ea&&p.match(/os (1|2|3_0|3_1)/i))c.hasHTML5=!1,c.html5Only=!0,c.oMC&&(c.oMC.style.display="none");else if(c.useHTML5Audio&&(!c.html5||!c.html5.canPlayType))c.hasHTML5=!1;if(c.useHTML5Audio&&c.hasHTML5)for(e in P=!0,d)if(d.hasOwnProperty(e)&&d[e].required)if(c.html5.canPlayType(d[e].type)){if(c.preferFlash&&(c.flash[e]||c.flash[d[e].type]))b=!0}else P=!1,b=!0;c.ignoreFlash&&(b=!1,P=!0);c.html5Only=c.hasHTML5&&c.useHTML5Audio&&!b;return!c.html5Only};aa=function(b){var e,d,a=0;if(b instanceof Array){e=
 ...
 * @version 1.1.3
 * @create 2014.2.7
 * @lastmodified 2014-05-17 12:02
 * @description Hermit Plugin
 * @author MuFeng (http://mufeng.me)
 * @url http://mufeng.me/hermit-for-wordpress.html
 **/
;(function(o,e,t){var i=soundManager,g=null,j=null,p=100,h=[],a={},m,q=-1;if("Microsoft Internet Explorer"==navigator.appName){var r=navigator.userAgent,s=/MSIE ([0-9]{1,}[.0-9]{0,})/;null!=s.exec(r)&&(q=parseFloat(RegExp.$1))}else"Netscape"==navigator.appName&&(r=navigator.userAgent,s=/Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/,null!=s.exec(r)&&(q=parseFloat(RegExp.$1)));m=q;var k="createTouch"in e||"ontouchstart"in o,n=k?"touchstart":"click",w=k?"touchstart":"mousedown",u=k?"touchmove":"mousemove",v=k?
    "touchend":"mouseup";i.url=hermit.url;i.debugMode=!1;i.preferFlash=5<m?!0:!1;a.init=function(){this.fn.getjson()};a.fn={handleHash:{},bind:e.addEventListener?function(c,b,d){b.addEventListener(c,function(){d.apply(this,arguments);a.fn.handleHash[c]=a.fn.handleHash[c]||[];a.fn.handleHash[c].push(arguments.callee)},!1)}:e.attachEvent?function(c,b,d){b.attachEvent("on"+c,function(){d.apply(this,arguments);a.fn.handleHash[c]=a.fn.handleHash[c]||[];a.fn.handleHash[c].push(arguments.callee)})}:void 0,unbind:e.removeEventListener?
    function(c,b){if(a.fn.handleHash[c]){var d=0,f=a.fn.handleHash[c].length;for(d;f>d;d+=1)b.removeEventListener(c,a.fn.handleHash[c][d],!1)}}:e.detachEvent?function(c,b){if(a.fn.handleHash[c]){var d=0,f=a.fn.handleHash[c].length;for(d;f>d;d+=1)b.detachEvent("on"+c,a.fn.handleHash[c][d])}}:void 0,rclass:/[\n\t]/g,rspaces:/\s+/,arraify:function(a){var b=[];try{b=Array.prototype.slice.call(a,0)}catch(d){for(var f,b=[],l=0;f=a[l++];)b.push(f)}return b},hasClass:function(c,b){return 0<=(" "+c.className+
    " ").replace(a.fn.rclass," ").indexOf(" "+b+" ")?!0:!1},addClass:function(c,b){if(b&&"string"==typeof b){var d=(b||"").split(a.fn.rspaces);if(1===c.nodeType)if(c.className){for(var f=" "+c.className+" ",l=c.className,e=0,g=d.length;g>e;e++)0>f.indexOf(" "+d[e]+" ")&&(l+=" "+d[e]);c.className=a.fn.trim(l)}else c.className=b}},removeClass:function(c,b){if(b&&"string"==typeof b||void 0===b){var d=(b||"").split(a.fn.rspaces);if(1===c.nodeType&&c.className)if(b){for(var f=(" "+c.className+" ").replace(a.fn.rclass,
    " "),e=0,g=d.length;g>e;e++)f=f.replace(" "+d[e]+" "," ");c.className=a.fn.trim(f)}else c.className=""}},getById:function(a){return e.getElementById(a)},getByTagName:function(c,b){return b=b||e,a.fn.arraify(b.getElementsByTagName(c))},getByClassName:function(c,b,d){if(b=b||e,b.getElementsByClassName)return a.fn.arraify(b.getElementsByClassName(c));for(var c=c.replace(/\-/g,"\\-"),f=[],b=a.fn.getByTagName(d||"*",b),d=b.length,c=RegExp("(^|\\s)"+c+"(\\s|$)");d--;)c.test(b[d].className)&&f.push(b[d]);
    return f.reverse(),f},each:function(a,b){if(t!=a.length)for(var d=0,f=a.length;f>d&&!1!==b.call(a[d],d,a[d]);d++);else for(name in a)b.call(a[name],name,a[name])},index:function(a,b){var d,f=b.length;for(d=0;f>d;d++)if(a==b[d])return d;return-1},trim:function(a){return a.replace(/^(\s|\u00A0)+/,"").replace(/(\s|\u00A0)+$/,"")},getjson:function(){var c=a.fn.getByClassName("hermit"),b=c.length-1;a.fn.each(c,function(c){var f=this,e=f.getAttribute("songs").split("#:");a.fn.ajaxp({url:"http://goxiami.sinaapp.com/"+
    ("songlist"==e[0]?"song":e[0])+"/"+e[1],param:{form:"hermit",version:hermit.version},after:function(e){200==e.msg&&(e=e.data.songs,a.fn.createPlayListUI.call(f,e,c),c==b&&a.fn.autoPlay())}})})},create:function(c){var b=this;j=null!=c?c:0;g=null!=g?g:0;a.sound&&(a.sound.destruct(),g==h[j].length&&(g=0));i.onready(function(){a.sound=i.createSound({id:"goXiami",url:h[j][g].src,volume:p,autoLoad:!1,onload:function(){3>this.readyState&&(a.fn.getByClassName("hermit-detail",b,"div")[0].innerHTML="\u97f3\u4e50\u64ad\u653e\u5668\u521d\u59cb\u5316\u5931\u8d25!")},
    whileloading:function(){a.fn.getByClassName("hermit-loaded",b,"div")[0].style.width=100*(this.bytesLoaded/this.bytesTotal)+"%"},whileplaying:function(){var c=a.fn.getByClassName("hermit-duration",b,"div")[0],f=a.fn.getByClassName("hermit-prosess-bar",b,"div")[0],e=100*(this.position/this.duration)+"%",g=a.fn.parseTime(this.position/1E3)+"/"+a.fn.parseTime(this.duration/1E3);!a.moving&&(f.style.width=e);c.innerHTML=g},onplay:function(){var c=a.fn.getByClassName("hermit-song",b,"div"),f=a.fn.getByClassName("hermit-detail",
        b,"div")[0];a.fn.each(c,function(){a.fn.removeClass(this,"selected")});a.fn.addClass(c[g],"selected");f.innerHTML=a.fn._expect(c[g].innerHTML,0,40,"...")+"  ("+(g+1)+"/"+h[j].length+")"},onpause:function(){},onfinish:function(){if(g++,a.sound.resume(),g<h[j].length)a.fn.create.call(b,j);else if(parseInt(b.getAttribute("loop"),10))a.fn.getByClassName("hermit-song",b,"div")[0].click();else{var c=a.fn.getByClassName("hermit-prosess-bar",b,"div")[0],f=a.fn.getByClassName("hermit-button",b,"div")[0],e=
        a.fn.getByClassName("hermit-duration",b,"div")[0],i=a.fn.getByClassName("hermit-song",b,"div");a.fn.each(i,function(){a.fn.removeClass(this,"selected")});c.style.width=0;j=g=null;a.sound=null;e.innerHTML="";a.fn.removeClass(f,"playing")}}});a.sound.play()})},createPlayListUI:function(c,b){var d=a.fn.getByClassName("hermit-list",this,"div")[0],e="";(h[b]=[])&&a.fn.each(c,function(){null!=this&&(h[b].push({src:this.song_src}),e+='<div class="hermit-song">'+this.song_title+" - "+this.song_author+"</div>")});
    d.innerHTML=e;a.fn.playEvent.call(this)},playEvent:function(){var c=this,b=a.fn.getByClassName("hermit-button",c,"div")[0],d=a.fn.getByClassName("hermit-volume",c,"div")[0],e=a.fn.getByClassName("hermit-listbutton",c,"div")[0],l=a.fn.getByClassName("hermit-list",c,"div")[0],i=a.fn.getByClassName("hermit-song",l,"div"),h=(parseInt(a.fn._getStyle(i[0],"height"))+1)*i.length,k=a.fn.getByClassName("hermit-prosess",c,"div")[0],m=a.fn.getByClassName("hermit-prosess-after",k,"div")[0],h=360>=h?h:360,h=h+
    "px";l.style.height=h;a.fn.each(i,function(){var d=a.fn.index(c,a.fn.getByClassName("hermit"));a.fn.bind(n,this,function(){var e=a.fn.index(this,i);if(j==d)e==g?b.click():(g=e,a.fn.create.call(c,d));else{if(a.sound){var f=a.fn.getByClassName("hermit")[j],h=a.fn.getByClassName("hermit-button",f,"div")[0],f=a.fn.getByClassName("hermit-song",f,"div")[g];a.fn.removeClass(h,"playing");a.fn.removeClass(f,"selected");a.sound.resume()}g=e;a.fn.addClass(b,"playing");a.fn.create.call(c,d)}})});a.fn.bind(n,
    b,function(){var d=a.fn.index(c,a.fn.getByClassName("hermit"));if(a.fn.hasClass(b,"playing"))a.fn.removeClass(b,"playing"),a.sound.pause();else if(a.fn.addClass(b,"playing"),a.sound&&j==d)a.sound.play();else{if(a.sound){var e=a.fn.getByClassName("hermit")[j],f=a.fn.getByClassName("hermit-button",e,"div")[0],e=a.fn.getByClassName("hermit-song",e,"div")[g];g=null;a.fn.removeClass(f,"playing");a.fn.removeClass(e,"selected")}a.fn.create.call(c,d)}});a.fn.bind(n,e,function(){a.fn.hasClass(c,"unexpand")?
    (a.fn.removeClass(c,"unexpand"),l.style.height=h):(a.fn.addClass(c,"unexpand"),l.style.height=0)});a.fn.bind(n,d,function(){var c=a.fn.getByClassName("hermit-volume",null,"div");a.fn.hasClass(d,"muted")?(a.fn.each(c,function(){a.fn.removeClass(this,"muted")}),p=100,a.sound&&a.sound.setVolume(100)):(a.fn.each(c,function(){a.fn.addClass(this,"muted")}),p=0,a.sound&&a.sound.setVolume(0))});a.fn.bind(n,k,function(c){if(a.sound){var b=parseInt(a.fn._getStyle(k,"width")),d=a.fn._offset(k).left,c=a.fn._pageEvent(c).pageX-
    d,c=c/b*a.sound.duration;a.sound.setPosition(c)}});a.fn.bind(w,m,a.fn._bind(a.fn._start,c))},autoPlay:function(){var c=a.fn.getByClassName("hermit");a.fn.each(c,function(){if(parseInt(this.getAttribute("auto"),10))return a.fn.getByClassName("hermit-button",this,"div")[0].click(),!1})},_pageEvent:function(a){if(a=a||o.event,k&&a.touches.length)a.pageX=a.touches.item(0).pageX,a.pageY=a.touches.item(0).pageY;else if("undefined"==typeof a.pageX){var b=e.documentElement,d=e.body;a.pageX=a.clientX+(b&&
    b.scrollLeft||d&&d.scrollLeft||0)-(b&&b.clientLeft||d&&d.clientLeft||0);a.pageY=a.clientY+(b&&b.scrollTop||d&&d.scrollTop||0)-(b&&b.clientTop||d&&d.clientTop||0)}return a},_expect:function(a,b,d,e){return e=a.length>d-b?e:"",a=a.slice(b,d),a+e},_offset:function(a){var b=a.getBoundingClientRect(),d=a.ownerDocument,a=d.body,d=d.documentElement;return{top:b.top+(self.pageYOffset||d.scrollTop||a.scrollTop)-(d.clientTop||a.clientTop||0),left:b.left+(self.pageXOffset||d.scrollLeft||a.scrollLeft)-(d.clientLeft||
    a.clientLeft||0)}},_getStyle:function(a,b){return 5<m&&9>m?(b=b.replace(/^(\w)/g,function(a,b){return b.toUpperCase()}),a["client"+b]):e.defaultView.getComputedStyle(a,null).getPropertyValue(b)},_bind:function(a,b){return function(){return a.apply(b,arguments)}},_start:function(){a.moving=!0;a.fn.bind(u,e,a.fn._bind(a.fn._move,this));a.fn.bind(v,e,a.fn._bind(a.fn._end,this));a.fn.bind("touchcancel",e,a.fn._bind(a.fn._end,this))},_move:function(c){event=a.fn._pageEvent(c);var b=a.fn.getByClassName("hermit-prosess",
    this,"div")[0],c=a.fn.getByClassName("hermit-prosess-bar",b,"div")[0],d=parseInt(a.fn._getStyle(b,"width")),b=a.fn._offset(b).left,b=event.pageX-b,d=b/d;c.style.width=100*(1<d?1:d)+"%"},_end:function(){a.fn.getByClassName("hermit-prosess-after",this,"div")[0];if(a.sound){var c=a.fn.getByClassName("hermit-prosess",this,"div")[0],b=a.fn.getByClassName("hermit-prosess-bar",c,"div")[0],c=parseInt(a.fn._getStyle(c,"width")),b=parseInt(a.fn._getStyle(b,"width")),b=b/c,b=(1<b?1:b)*a.sound.duration;a.sound.setPosition(b)}a.fn.unbind(u,
    e);a.fn.unbind(v,e);a.fn.unbind("touchcancel",e);try{delete a.moving}catch(d){a.moving=t}a.fn.handleHash={}},ajaxp:function(c){setTimeout(function(){var b=(new Date).valueOf(),d=e.createElement("script");body=e.documentElement;head=body.getElementsByTagName("head")[0];callbackName="hermit"+parseInt(999999*Math.random());c.param.callback=callbackName;c.param._=b;o[callbackName]=function(a){c.after.call(this,a);head.removeChild(d)};d.src=c.url+"?"+a.fn.serialize(c.param);head.appendChild(d)},0)},_loadScript:function(c,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            b){setTimeout(function(){var d=e.createElement("script");d.src=c;d.readyState?a.fn.bind("readystatechange",d,function(){("loaded"===d.readyState||"complete"===d.readyState)&&(b&&b(),a.fn.unbind("readystatechange",d))}):a.fn.bind("load",d,function(){b&&b();a.fn.unbind("load",d)});e.getElementsByTagName("head")[0].appendChild(d)},0)},serialize:function(a){var b=[];for(key in a)key=[key,a[key]].join("="),b.push(key);return b.join("&")},parseTime:function(a){if(!isFinite(a)||0>a)return"--:--";var b=Math.floor(a/
    60),a=Math.floor(a)%60;return(10>b?"0"+b:b)+":"+(10>a?"0"+a:a)}};a.init();window.hermitInit=function(){h=g=null;i=[];a.sound&&a.sound.destruct();a.init()}})(window,document);