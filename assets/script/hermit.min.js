...
d))}):a.fn.bind("load",d,function(){b&&b();a.fn.unbind("load",d)});f.getElementsByTagName("head")[0].appendChild(d)},0)},serialize:function(a){var b=[];for(key in a)key=[key,a[key]].join("="),b.push(key);return b.join("&")},parseTime:function(a){if(!isFinite(a)||0>a)return"--:--";var b=Math.floor(a/60),a=Math.floor(a)%60;return(10>b?"0"+b:b)+":"+(10>a?"0"+a:a)}};a.init()})(window,document);