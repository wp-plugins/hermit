...
;(function(p,e,u){var h=soundManager,g=null,j=null,q=100,i=[],a={},o,r=-1;if("Microsoft Internet Explorer"==navigator.appName){var s=navigator.userAgent,t=/MSIE ([0-9]{1,}[.0-9]{0,})/;null!=t.exec(s)&&(r=parseFloat(RegExp.$1))}else"Netscape"==navigator.appName&&(s=navigator.userAgent,t=/Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/,null!=t.exec(s)&&(r=parseFloat(RegExp.$1)));o=r;var k="createTouch"in e||"ontouchstart"in p,m=k?"touchstart":"click",x=k?"touchstart":"mousedown",v=k?"touchmove":"mousemove",w=k?
    ...
    serialize:function(a){var b=[];for(key in a)key=[key,a[key]].join("="),b.push(key);return b.join("&")},parseTime:function(a){if(!isFinite(a)||0>a)return"--:--";var b=Math.floor(a/60),a=Math.floor(a)%60;return(10>b?"0"+b:b)+":"+(10>a?"0"+a:a)}};a.init()})(window,document);